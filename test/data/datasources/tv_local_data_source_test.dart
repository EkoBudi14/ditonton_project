...
import 'package:ditonton/data/datasources/tv_local_data_soure.dart';
...
void main() {
  ...
  group('Get Tv Detail By Id', () {
    ...
    test('should return Tv Detail Table when data is found', () async {
      // arrange
      when(mockDatabaseHelper.getMovieByIdTv(tId))
  ...
  group('cache now playing Tv', () {
    ...
    test('should return list of movies from db when data exist', () async {
      // arrange
      when(mockDatabaseHelper.getCacheMoviesTv('now playing'))
